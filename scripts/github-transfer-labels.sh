# Copied from: https://douglascayers.com/2019/08/01/how-to-export-and-import-github-issue-labels-between-projects/
...
SRC_GH_USER="jimrybarski"
SRC_GH_REPO="$1"

# The target repository to add or update labels.
TGT_GH_USER="jimrybarski"
TGT_GH_REPO="$2"
